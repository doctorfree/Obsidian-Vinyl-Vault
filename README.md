...
This Obsidian vault was created by exporting my vinyl library on [Discogs](https://discogs.com). Each Markdown document created in this way has been augmented with tags and metadata that can be used to query the vault with Dataview.
...
The `Obsidian Vinyl Vault` is part of the `Obsidian Media Vault`.
